            ...
            <Container>
                ...
                <Grid container justify="space-between" >
                    <Grid justify="flex-start">
                        <Grid item style={{padding:"2em"}}>
                            <Link to="/products">
                                <Typography variant="h5"  color="textSecondary">Grocery Items</Typography>
                            </Link>
                        </Grid>
                    </Grid>
                    { auth && user !== null ? 
                ...
                <Grid container justify="space-around" alignItems="center" direction="column" >
                        ...
                        <Grid xs={12} sm={6} item>
                            <Typography variant="h3" align="center" className={classes.heading} >Welcome to E-Grocery Store</Typography>
                            <Typography variant="subtitle1" align="center" color="textSecondary" gutterBottom={true} >Shop for new Kitchen items</Typography>
                        </Grid>
                ...
                <Grid container justify="center" alignItems="center" style={{marginTop:"3em"}} >
                    ...
                    <Grid xs={12} sm={2} item>
                        <Typography variant="h4" color="secondary">Grab all household items at affordable prices</Typography>
                    </Grid>
                    ...
                    <Grid xs={12} sm={4} item>
                        <img src={`https://${data.data[5].image}`} className={classes.image} />                    
                    </Grid>
                    <Grid xs={12} sm={4} item>
                        <img src={`https://${data.data[6].image}`} className={classes.image} />                    
                    </Grid>
                    <Grid xs={12} sm={4} item>
                        <img src={`https://${data.data[7].image}`} className={classes.image} />                    
                    </Grid>
                    <Grid xs={12} sm={4} item>
                        <img src={`https://${data.data[4].image}`} className={classes.image} />                    
                    </Grid>
                ...
                <Grid container justify="center" alignItems="center" style={{marginTop:"5em"}} direction="column">
                    ...
                    <Grid item>
                            ...
                            color="textSecondary">Register to Explore more household items</Typography>
